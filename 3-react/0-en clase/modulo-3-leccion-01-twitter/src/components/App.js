import logoAdalab from '../images/adalab-logo.png';
import bannerAdalab from '../images/adalab-banner.jpg';
      ...
      <main className="main">
        <section className="main__header">
          <header>
            ...
            <img src={bannerAdalab} alt="Banner de Adalab" />

            <div className="header__content">
              <div className="header__profile-image">
                <img src={logoAdalab} alt="Imagen de perfil de Adalab" />
              </div>
